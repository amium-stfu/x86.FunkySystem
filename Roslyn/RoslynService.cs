...
namespace FunkySystem.Roslyn
{
    public class CodeDocument
    {
        ...
        public RoslynDocument? Document => FunkyCore.Roslyn.GetDocumentByFilename(Filename);
        ...
        public CodeDocument(string filename, string code, bool active, RoslynService roslyn, string deviceType)
        {
            Filename = filename;
            Code = code;
            _roslyn = roslyn;
    ...
    public sealed partial class RoslynService
    {
        ...
        public void CreateProject()
        {
            ...
            else
            {
                ...
                // Explizit die Kern-Assembly hinzufügen, die 'object', 'Task' etc. enthält.
                ...
                references.Add(MetadataReference.CreateFromFile(typeof(System.Threading.Thread).Assembly.Location));
        ...
        public CodeDocument AddCodeDocument(string filename, string code, bool active, string deviceType)
        {
            if (_adhocWs == null || _projectId == null)
            ...
            lock (_docMap)
            {
                _docMap[filename] = new CodeDocument(filename, code, active, this, deviceType);
            }
