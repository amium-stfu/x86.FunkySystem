...
namespace FunkySystem.SequenceEditor
{
    public class DocumentEditor : Scintilla
    {
        ...
        public DocumentEditor(CodeDocument doc = null) : base()
        {
            
            if(doc == null)
            {
                doc = new CodeDocument("Untitled","",false,FunkyCore.Roslyn,"");
        ...
        private async void RoslynAutoComplete_CharAdded(object sender, CharAddedEventArgs e)
        {
            ...
            if (c == '.')
            {
                ...
                var suggestions = await FunkyCore.Roslyn.GetAutoCompleteSuggestionsAsync(
                    Target.Document,
                    Target.Code,
                    CurrentPosition,
            ...
            var filteredSuggestions = await FunkyCore.Roslyn.GetAutoCompleteSuggestionsAsync(
                Target.Document,
                Target.Code,
                CurrentPosition,
                completeText
        ...
        public void Init()
        {
          ...
          //  HScrollBar = false;
            ...
            CharAdded += async (s, e) =>
            {
              //  FunkyCore.ThisBook.Modified = true;
                char c = (char)e.Char;
        ...
        private void DocumentEditor_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            //{
            //    FunkyCore.Explorer.FindReplace.Show();
            //    e.Handled = true;
            //    e.SuppressKeyPress = true;
            //}
        ...
        private void InitEditorContextMenu()
        {
            ...
            //miGoto.Click += async (_, __) => await FunkyCore.Explorer.GoToDefinition();
            //EditorContextMenu.Items.Add(miGoto);

            //var miRename = new ToolStripMenuItem("Rename...");
            //miRename.Click += async (_, __) => await FunkyCore.Explorer.RenameSymbol();
