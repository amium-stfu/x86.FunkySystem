...
{
    public class DeviceCycler : FunkyDevice
    {
        ...
        public DeviceCycler(string name) : base(name)
        {
            ...
            Temperature = SignalPool.GetModule("10.ClimaChamber.Oven.TC", format: "0.00", text: "Temperature", unit: "°C");
